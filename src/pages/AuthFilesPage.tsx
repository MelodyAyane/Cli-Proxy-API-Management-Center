...
import { AuthFilesProxyManagerModal } from '@/features/authFiles/components/AuthFilesProxyManagerModal';
      ...
      <Card
        ...
        extra={
          <div className={styles.headerActions}>
            ...
            >
              {t('auth_files.proxy_manager_button')}
            </Button>
            <Button
              size="sm"
